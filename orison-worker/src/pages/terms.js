...
export function HTML_TERMS(lang) { return `<!DOCTYPE html>
<html lang="${lang}">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>${T('terms.title', lang)}</title>
...
<h1 class="legal-title">${T('terms.h1', lang)}</h1>
...
<ol class="legal-ol"><li><strong>データの自動削除</strong>　保存されたデータは、利用者が設定した有効期限（設定した復号時間＋1か月）の経過その他運営者が定める条件に従い、自動的に削除される場合があります。なお、受信者がコンテンツを復号した後も、有効期限が到来するまでは、同一のリンクから再度アクセスすることができます（復号後に即座に削除されるわけではありません）。運営者は、削除の時期、方法及び削除されたデータの復元可能性について一切保証しません。運営者は、事前の通知なくデータを削除することができます。</li></ol>
