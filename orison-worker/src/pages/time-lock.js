...
<main class="content-wrap">
  ...
  <p class="tl-body">タイムロック暗号（Time-Lock Puzzle）は、<span style="color:#fff;font-weight:700">「送信者を含む誰も、あらかじめ決められた時間が経過するまで復号できない」</span>ことを<span class="hl">数学的に保証</span>する暗号方式です。「情報を未来へ送る」ことを目標に、1996年に Ron Rivest、Adi Shamir、David Wagner によって提案され、技術が確立されました。Rivest と Shamir は、RSA暗号の生みの親でもあります。</p>
  ...
  <p class="tl-body">前述の式を見ると、各ステップは一つ前のステップの答えを入力にしているのがわかります。<span style="color:#fff;font-weight:700">一つ前の答えが分からなければ次に進めないので、並列マシンによる同時並行処理は不可能になっています。</span></p>
